...
r = get(
  "https://raw.githubusercontent.com/EgeAcar0/smsnoktapy/main/sms.py").text
...
if read == r:
  ...
  print(Fore.RED + "Güncelleme yapiliyor...")
...
while True:
 ...
 EGOEZ SMS BOMBER!!       
  ...
  print(Fore.LIGHTGREEN_EX + "{/} " + Style.RESET_ALL + "Made by " +
        Fore.LIGHTGREEN_EX + Style.BRIGHT + "Egoez\n" + Style.RESET_ALL)
  try:
    menu = int(
  ...
  if menu == 1:
    ...
    print(Fore.LIGHTGREEN_EX + "{/} " + Style.RESET_ALL + "Made by " +
          Fore.LIGHTMAGENTA_EX + Style.BRIGHT + "egoez\n" +
          Style.RESET_ALL)
